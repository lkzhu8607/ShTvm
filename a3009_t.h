...
#ifndef V1_3AA3009_T_20140523_161608
#define V1_3AA3009_T_20140523_161608

 
///////////////////////////////////////////////////////
//Contents:	The row class type definition of a3009_t
//Name:	a3009_t_rowtype
class a3009_t_rowtype {
 
public:

	std::string		m_strTblName;			// 1		7.0.12  3009-操作员表。此类交互应用于CC向SC传送操作员信息。这是一种参数， 
	long		m_lVer;			// 2		参数版本 
	...
	long		m_lOperatorNum;			// a	1	操作员编号  Long 4 
	u8arr_t<8>		m_PIN;			// a	2	加密后的PIN 操作员PIN使用6个字节的string类型的密码，并采用MD5算法生成摘要的前8字节 Block 8 
	wl::tuint8		m_OpManType;			// a	3	操作员类别  Byte 1 
	wl::tuint8		m_AccDeviceType;			// a	4	可访问设备类别  Byte 1 
	u8arr_t<32>		m_RES_01;			// a	5	[保留]  Byte 32 
	std::string		m_ValidityPeriod;			// a	6	有效期 过期日期 GMT 4 
	u8arr_t<4>		m_RES_02;			// a	7	[保留]  Byte 4 
	wl::tuint8		m_RES_03;			// a	8	[保留]  Byte 1 
	wl::tuint8		m_RES_04;			// a	9	[保留] 
...
public:
	...
	a3009_t_rowtype()
	{
		...
		m_ValidityPeriod = wl::SDte::GetNow().ReadString();
		//m_RES_02 = //use default
		m_RES_03 = 0;
		m_RES_04 = 0;
	}

	virtual ~a3009_t_rowtype(){;}
	

	//operator == 
	bool operator == (const a3009_t_rowtype & rhs) const
	{
		return this == &rhs;
	}
...
public:
	...
	std::string & Serialize( std::string & strOut )
	{
		...
		strOut += std::string(buf2);
		strOut += std::string("/");
		buf1 = (const char *)reinterpret_cast<char *>(&reinterpret_cast<char&>(m_PIN));
		len1 = sizeof(m_PIN);
		if( (int)v.size() < ( len1 * 2 + 4 ) ) v.resize( len1 * 2 + 4 );
		buf2 = (char*)(&(v[0]));
		en( buf1, len1, buf2 );
		strOut += std::string(buf2);
		strOut += std::string("/");
		buf1 = (const char *)reinterpret_cast<char *>(&reinterpret_cast<char&>(m_OpManType));
		len1 = sizeof(m_OpManType);
		if( (int)v.size() < ( len1 * 2 + 4 ) ) v.resize( len1 * 2 + 4 );
		buf2 = (char*)(&(v[0]));
		en( buf1, len1, buf2 );
		strOut += std::string(buf2);
		strOut += std::string("/");
		buf1 = (const char *)reinterpret_cast<char *>(&reinterpret_cast<char&>(m_AccDeviceType));
		len1 = sizeof(m_AccDeviceType);
		if( (int)v.size() < ( len1 * 2 + 4 ) ) v.resize( len1 * 2 + 4 );
		buf2 = (char*)(&(v[0]));
		en( buf1, len1, buf2 );
		strOut += std::string(buf2);
		...
		strOut += std::string(buf2);
		strOut += std::string("/");
		buf1 = (const char *)m_ValidityPeriod.c_str();
		len1 = (long)(m_ValidityPeriod.length()*sizeof(char)+sizeof(char));
		if( (int)v.size() < ( len1 * 2 + 4 ) ) v.resize( len1 * 2 + 4 );
		buf2 = (char*)(&(v[0]));
		en( buf1, len1, buf2 );
		strOut += std::string(buf2);
	...
	a3009_t_rowtype & Unserialize( const char * strIn )
	{
		const char *buf1;
		char *buf2;
		buf1 = strIn;
		...
		buf2 = (char*)buf1;
		 if( *buf2!='}') {buf1 = de( buf2 );  
		 /*if( *buf2!='}')*/ m_PIN = *(u8arr_t<8>*)buf2; }else return *this; 
		buf2 = (char*)buf1;
		 if( *buf2!='}') {buf1 = de( buf2 );  
		 /*if( *buf2!='}')*/ m_OpManType = *(wl::tuint8*)buf2; }else return *this; 
		buf2 = (char*)buf1;
		 if( *buf2!='}') {buf1 = de( buf2 );  
		 /*if( *buf2!='}')*/ m_AccDeviceType = *(wl::tuint8*)buf2; }else return *this; 
		buf2 = (char*)buf1;
		 if( *buf2!='}') {buf1 = de( buf2 );  
		 /*if( *buf2!='}')*/ m_RES_01 = *(u8arr_t<32>*)buf2; }else return *this; 
		buf2 = (char*)buf1;
		 if( *buf2!='}') {buf1 = de( buf2 );  
		 /*if( *buf2!='}')*/ m_ValidityPeriod = (char*)buf2; }else return *this; 
		buf2 = (char*)buf1;
		 if( *buf2!='}') {buf1 = de( buf2 );  
	...
	a3009_t_rowtype & Unserialize( wl::tchar * p_begin, wl::tchar ** pp_end )
	{
		char *buf1 = p_begin;
		char *buf2;
		buf2 = (char*)buf1 + 4;
		...
		buf2 = (char*)buf1 + 4;
		buf1 = buf2 + *(wl::tuint32*)buf1;
		m_PIN = *(u8arr_t<8>*)buf2;
		buf2 = (char*)buf1 + 4;
		buf1 = buf2 + *(wl::tuint32*)buf1;
		m_OpManType = *(wl::tuint8*)buf2;
		buf2 = (char*)buf1 + 4;
		buf1 = buf2 + *(wl::tuint32*)buf1;
		m_AccDeviceType = *(wl::tuint8*)buf2;
		buf2 = (char*)buf1 + 4;
		buf1 = buf2 + *(wl::tuint32*)buf1;
		m_RES_01 = *(u8arr_t<32>*)buf2;
		buf2 = (char*)buf1 + 4;
		buf1 = buf2 + *(wl::tuint32*)buf1;
		m_ValidityPeriod = (char*)buf2;
		buf2 = (char*)buf1 + 4;
		buf1 = buf2 + *(wl::tuint32*)buf1;
...
///////////////////////////////////////////////////////////////
//Function:	GetCol_PIN
//Effect:	get ref of col. col is PIN
//Return:	u8arr_t<8> & 
	u8arr_t<8> & GetCol_PIN(void)
	{
		return m_PIN;
	}

////////////////////////////////////////////////////////
//Function:	GetCol_OpManType
//Effect:	get ref of col. col is OpManType
//Return:	wl::tuint8 & 
	wl::tuint8 & GetCol_OpManType(void)
	{
		return m_OpManType;
	}

////////////////////////////////////////////////////////////////
//Function:	GetCol_AccDeviceType
//Effect:	get ref of col. col is AccDeviceType
//Return:	wl::tuint8 & 
	wl::tuint8 & GetCol_AccDeviceType(void)
	{
		return m_AccDeviceType;
	}
...
//Return:	u8arr_t<32> & 
	u8arr_t<32> & GetCol_RES_01(void)
	{
		return m_RES_01;
	}

////////////////////////////////////////////////////////////
//Function:	GetCol_ValidityPeriod
//Effect:	get ref of col. col is ValidityPeriod
//Return:	std::string & 
	std::string & GetCol_ValidityPeriod(void)
	{
...
//Return:	return the column number, int.
	int GetColNumber( std::string strColName ) 
	{
		...
		if( strColName == "OpManType" )
		{
			return 9;
		}
		if( strColName == "AccDeviceType" )
		{
			return 10;
		}
...
//Return:	return col value in string format.
	...
	STRINGT GetColStr( int iColNum )
	{
		...
		if( iColNum == 8 )
		{
			return wl::SStrf::b2s(m_PIN);
		}
		if( iColNum == 9 )
		{
			return wl::SStrf::sltoa(m_OpManType);
		}
		if( iColNum == 10 )
		{
			return wl::SStrf::sltoa(m_AccDeviceType);
		}
		if( iColNum == 11 )
		{
...
//Return:	no return.
	...
	void SetColVal( int iColNum, STRINGT strValPARA )
	{
		...
		if( iColNum == 8 )
		{
			wl::SStrf::s2b(strValPARA,m_PIN);
		}
		if( iColNum == 9 )
		{
			m_OpManType=(wl::tuint8)wl::SStrf::satol(strValPARA);
		}
		if( iColNum == 10 )
		{
			m_AccDeviceType=(wl::tuint8)wl::SStrf::satol(strValPARA);
		}
		if( iColNum == 11 )
		{
...
private:
	...
	a3009_t_rowtype m_EmptyRow;
	std::vector<a3009_t_rowtype>  m_DATAcorpora;
 
public:

	typedef a3009_t_rowtype 	ROWTYPE;
	typedef std::vector<long> 	RPSTYPE; //RPS(return pointer set) type definition
	typedef std::vector<a3009_t_rowtype>::iterator 	TBLITTYPE;
...
public:
	...
	//operator == 
	bool operator == (const a3009_t & rhs) const
	{
		return this == &rhs;
	}
...
public:
	...
	a3009_t &  Unserialize( const char * strIn , int biAppend = 0 ) //if append==0, it would over-write the current tbl. 
	{
		char *p1,*p2;
		p1 = (char*)strIn;
		if(biAppend==0) Clear();
	...
	a3009_t & Unserialize( wl::SCake & ckIn , int biAppend = 0 )
	{
		char *p1,*p2;
		p1 = p2 = (char*)ckIn.buf();
		if(biAppend==0) Clear();
...
//Return:	a3009_t_rowtype&
	a3009_t_rowtype & GetRow(long lRowNum)
	{
		if(lRowNum>=0&&lRowNum<(long)m_DATAcorpora.size())
		return m_DATAcorpora[lRowNum];
		else 
		{
			a3009_t_rowtype tmpEmptyrow;
...
//Return:	a3009_t_rowtype&
	a3009_t_rowtype & GetRow(const std::vector<long> & vRps, long lRowNum)
	{
		long ltmp;
		do{
		{
...
//Return:	no return
	void Add(const a3009_t_rowtype & varRow)
	{
...
//Return:	a3009_t_rowtype&
	a3009_t_rowtype & SelE1_strTblName(std::string strVal) 
	{
...
//Effect:	select 1st row where col=val, or return default row.
//Return:	a3009_t_rowtype&
	a3009_t_rowtype & SelE1_lVer(long iVal) 
	{
		std::vector<long> vRps ;
		SelE_lVer( iVal, vRps );
		return GetRow( vRps, 0 );
...
//Effect:	select 1st row where col=val, or return default row.
//Return:	a3009_t_rowtype&
	a3009_t_rowtype & SelE1_strAffectDateTime(std::string strVal) 
	{
		std::vector<long> vRps ;
...
//Effect:	select 1st row where col=val, or return default row.
//Return:	a3009_t_rowtype&
	a3009_t_rowtype & SelE1_biDelFlag(wl::tuint8 iVal) 
	{
		std::vector<long> vRps ;
...
//Effect:	select 1st row where col=val, or return default row.
//Return:	a3009_t_rowtype&
	a3009_t_rowtype & SelE1_biIsAffect(wl::tuint8 iVal) 
	{
		std::vector<long> vRps ;
...
//Effect:	select 1st row where col=val, or return default row.
//Return:	a3009_t_rowtype&
	a3009_t_rowtype & SelE1_strStampDateTime(std::string strVal) 
	{
		std::vector<long> vRps ;
...
//Effect:	select 1st row where col=val, or return default row.
//Return:	a3009_t_rowtype&
	a3009_t_rowtype & SelE1_strDataRef(std::string strVal) 
	{
		std::vector<long> vRps ;
...
//Effect:	select 1st row where col=val, or return default row.
//Return:	a3009_t_rowtype&
	a3009_t_rowtype & SelE1_lOperatorNum(long iVal) 
	{
		std::vector<long> vRps ;
...
//Effect:	select and build RPS where col=val use traverse
//Return:	no return
	void SelE_PIN(u8arr_t<8> aVal, std::vector<long> & vRps, std::vector<long> * pRefRps=NULL) //(ni)
	{
		for(long ltmp=0;ltmp<(long)m_DATAcorpora.size();ltmp++)
		if(m_DATAcorpora[ltmp].m_PIN==aVal)
		if( !pRefRps || !pRefRps->empty() && std::binary_search( pRefRps->begin(), pRefRps->end(), ltmp ) ) vRps.push_back( ltmp );
	}
...
//Effect:	select 1st row where col=val, or return default row.
//Return:	a3009_t_rowtype&
	a3009_t_rowtype & SelE1_PIN(u8arr_t<8> aVal) 
	{
		std::vector<long> vRps ;
		SelE_PIN( aVal, vRps );
		return GetRow( vRps, 0 );
...
//Effect:	select and build RPS where col=val. clear rps first.
//Return:	no return
	void SelEc_PIN(u8arr_t<8> aVal, std::vector<long> & vRps, std::vector<long> * pRefRps=NULL) //()
	{
		vRps.clear();
		SelE_PIN(aVal, vRps, pRefRps);
	}

////////////////////////////////////////////////////////
//Function:	SelE_OpManType
//Effect:	select and build RPS where col=val use traverse
//Return:	no return
	void SelE_OpManType(wl::tuint8 iVal, std::vector<long> & vRps, std::vector<long> * pRefRps=NULL) //(ni)
	{
		for(long ltmp=0;ltmp<(long)m_DATAcorpora.size();ltmp++)
		if(m_DATAcorpora[ltmp].m_OpManType==iVal)
		if( !pRefRps || !pRefRps->empty() && std::binary_search( pRefRps->begin(), pRefRps->end(), ltmp ) ) vRps.push_back( ltmp );
	}

//////////////////////////////////////////////////////////////
//Function:	SelE1_OpManType
//Effect:	select 1st row where col=val, or return default row.
//Return:	a3009_t_rowtype&
	a3009_t_rowtype & SelE1_OpManType(wl::tuint8 iVal) 
	{
		std::vector<long> vRps ;
		SelE_OpManType( iVal, vRps );
		return GetRow( vRps, 0 );
	}

///////////////////////////////////////////////////////
//Function:	SelEc_OpManType
//Effect:	select and build RPS where col=val. clear rps first.
//Return:	no return
	void SelEc_OpManType(wl::tuint8 iVal, std::vector<long> & vRps, std::vector<long> * pRefRps=NULL) //()
	{
		vRps.clear();
		SelE_OpManType(iVal, vRps, pRefRps);
	}

///////////////////////////////////////////////////////
//Function:	SelE_AccDeviceType
//Effect:	select and build RPS where col=val use traverse
//Return:	no return
	void SelE_AccDeviceType(wl::tuint8 iVal, std::vector<long> & vRps, std::vector<long> * pRefRps=NULL) //(ni)
	{
		for(long ltmp=0;ltmp<(long)m_DATAcorpora.size();ltmp++)
		if(m_DATAcorpora[ltmp].m_AccDeviceType==iVal)
		if( !pRefRps || !pRefRps->empty() && std::binary_search( pRefRps->begin(), pRefRps->end(), ltmp ) ) vRps.push_back( ltmp );
	}

/////////////////////////////////////////////////////////////////
//Function:	SelE1_AccDeviceType
//Effect:	select 1st row where col=val, or return default row.
//Return:	a3009_t_rowtype&
	a3009_t_rowtype & SelE1_AccDeviceType(wl::tuint8 iVal) 
	{
		std::vector<long> vRps ;
		SelE_AccDeviceType( iVal, vRps );
		return GetRow( vRps, 0 );
	}

//////////////////////////////////////////////////////////
//Function:	SelEc_AccDeviceType
//Effect:	select and build RPS where col=val. clear rps first.
//Return:	no return
	void SelEc_AccDeviceType(wl::tuint8 iVal, std::vector<long> & vRps, std::vector<long> * pRefRps=NULL) //()
	{
		vRps.clear();
		SelE_AccDeviceType(iVal, vRps, pRefRps);
	}
...
//Effect:	select and build RPS where col=val use traverse
//Return:	no return
	void SelE_RES_01(u8arr_t<32> aVal, std::vector<long> & vRps, std::vector<long> * pRefRps=NULL) //(ni)
	{
		for(long ltmp=0;ltmp<(long)m_DATAcorpora.size();ltmp++)
...
//Effect:	select 1st row where col=val, or return default row.
//Return:	a3009_t_rowtype&
	a3009_t_rowtype & SelE1_RES_01(u8arr_t<32> aVal) 
	{
		std::vector<long> vRps ;
...
//Effect:	select and build RPS where col=val. clear rps first.
//Return:	no return
	void SelEc_RES_01(u8arr_t<32> aVal, std::vector<long> & vRps, std::vector<long> * pRefRps=NULL) //()
	{
		vRps.clear();
...
////////////////////////////////////////////////////////////////
//Function:	SelE_ValidityPeriod
//Effect:	select and build RPS where col=val use traverse
//Return:	no return
	void SelE_ValidityPeriod(std::string strVal, std::vector<long> & vRps, std::vector<long> * pRefRps=NULL) //(ni)
	{
		for(long ltmp=0;ltmp<(long)m_DATAcorpora.size();ltmp++)
		if(m_DATAcorpora[ltmp].m_ValidityPeriod==strVal)
		if( !pRefRps || !pRefRps->empty() && std::binary_search( pRefRps->begin(), pRefRps->end(), ltmp ) ) vRps.push_back( ltmp );
	}

//////////////////////////////////////////////////////////////
//Function:	SelE1_ValidityPeriod
//Effect:	select 1st row where col=val, or return default row.
//Return:	a3009_t_rowtype&
	a3009_t_rowtype & SelE1_ValidityPeriod(std::string strVal) 
	{
		std::vector<long> vRps ;
		SelE_ValidityPeriod( strVal, vRps );
		return GetRow( vRps, 0 );
	}

////////////////////////////////////////////////////////////
//Function:	SelEc_ValidityPeriod
//Effect:	select and build RPS where col=val. clear rps first.
//Return:	no return
	void SelEc_ValidityPeriod(std::string strVal, std::vector<long> & vRps, std::vector<long> * pRefRps=NULL) //()
	{
		vRps.clear();
		SelE_ValidityPeriod(strVal, vRps, pRefRps);
	}
...
//Effect:	select 1st row where col=val, or return default row.
//Return:	a3009_t_rowtype&
	a3009_t_rowtype & SelE1_RES_02(u8arr_t<4> aVal) 
	{
		std::vector<long> vRps ;
...
//Effect:	select 1st row where col=val, or return default row.
//Return:	a3009_t_rowtype&
	a3009_t_rowtype & SelE1_RES_03(wl::tuint8 iVal) 
	{
		std::vector<long> vRps ;
...
//Effect:	select 1st row where col=val, or return default row.
//Return:	a3009_t_rowtype&
	a3009_t_rowtype & SelE1_RES_04(wl::tuint8 iVal) 
	{
		std::vector<long> vRps ;
