...
#ifndef V1_3AA5041_T_20170310_141632
#define V1_3AA5041_T_20170310_141632

 
///////////////////////////////////////////////////////
//Contents:	The row class type definition of a5041_t
//Name:	a5041_t_rowtype
class a5041_t_rowtype {
 
public:

	std::string		m_strTblName;			// 1		a5041 
	long		m_lVer;			// 2		参数版本 
	...
	u8arr_t<8>		m_s0;			// a	1	机器状态0 
	u8arr_t<8>		m_s1;			// a	2	机器状态1 
	uiarr_t<long,335>		m_e_old;			// a	3	事件——原状态 
	uiarr_t<long,335>		m_e;			// a	4	事件-现状态	0=正常。1=出事 
	uiarr_t<long,335>		m_e_flag;			// a	5	事件-已发生过标志	上电应该全清0 
	u8arr_t<23>		m_RES;			// a	6 
	uiarr_t<long,34>		m_RES2;			// a	7 
...
public:
	...
	a5041_t_rowtype()
	{
		...
		//m_e_old = //use default
		//m_e = //use default
		//m_e_flag = //use default
		//m_RES = //use default
		//m_RES2 = //use default
	}

	virtual ~a5041_t_rowtype(){;}
	

	//operator == 
	bool operator == (const a5041_t_rowtype & rhs) const
	{
		return this == &rhs;
	}
...
public:
	...
	std::string & Serialize( std::string & strOut )
	{
		...
		strOut += std::string(buf2);
		strOut += std::string("/");
		buf1 = (const char *)reinterpret_cast<char *>(&reinterpret_cast<char&>(m_s0));
		len1 = sizeof(m_s0);
		if( (int)v.size() < ( len1 * 2 + 4 ) ) v.resize( len1 * 2 + 4 );
		buf2 = (char*)(&(v[0]));
		en( buf1, len1, buf2 );
		strOut += std::string(buf2);
		strOut += std::string("/");
		buf1 = (const char *)reinterpret_cast<char *>(&reinterpret_cast<char&>(m_s1));
		len1 = sizeof(m_s1);
		if( (int)v.size() < ( len1 * 2 + 4 ) ) v.resize( len1 * 2 + 4 );
		buf2 = (char*)(&(v[0]));
		en( buf1, len1, buf2 );
		strOut += std::string(buf2);
		strOut += std::string("/");
		buf1 = (const char *)reinterpret_cast<char *>(&reinterpret_cast<char&>(m_e_old));
		len1 = sizeof(m_e_old);
		if( (int)v.size() < ( len1 * 2 + 4 ) ) v.resize( len1 * 2 + 4 );
		buf2 = (char*)(&(v[0]));
		en( buf1, len1, buf2 );
		strOut += std::string(buf2);
		strOut += std::string("/");
		buf1 = (const char *)reinterpret_cast<char *>(&reinterpret_cast<char&>(m_e));
		len1 = sizeof(m_e);
		if( (int)v.size() < ( len1 * 2 + 4 ) ) v.resize( len1 * 2 + 4 );
		buf2 = (char*)(&(v[0]));
		en( buf1, len1, buf2 );
		strOut += std::string(buf2);
		strOut += std::string("/");
		buf1 = (const char *)reinterpret_cast<char *>(&reinterpret_cast<char&>(m_e_flag));
		len1 = sizeof(m_e_flag);
		if( (int)v.size() < ( len1 * 2 + 4 ) ) v.resize( len1 * 2 + 4 );
		buf2 = (char*)(&(v[0]));
		en( buf1, len1, buf2 );
		strOut += std::string(buf2);
		strOut += std::string("/");
		buf1 = (const char *)reinterpret_cast<char *>(&reinterpret_cast<char&>(m_RES));
		len1 = sizeof(m_RES);
		if( (int)v.size() < ( len1 * 2 + 4 ) ) v.resize( len1 * 2 + 4 );
		buf2 = (char*)(&(v[0]));
		en( buf1, len1, buf2 );
		strOut += std::string(buf2);
		strOut += std::string("/");
		buf1 = (const char *)reinterpret_cast<char *>(&reinterpret_cast<char&>(m_RES2));
		len1 = sizeof(m_RES2);
		if( (int)v.size() < ( len1 * 2 + 4 ) ) v.resize( len1 * 2 + 4 );
		buf2 = (char*)(&(v[0]));
		en( buf1, len1, buf2 );
	...
	a5041_t_rowtype & Unserialize( const char * strIn )
	{
		const char *buf1;
		char *buf2;
		buf1 = strIn;
		...
		buf2 = (char*)buf1;
		 if( *buf2!='}') {buf1 = de( buf2 );  
		 /*if( *buf2!='}')*/ m_s0 = *(u8arr_t<8>*)buf2; }else return *this; 
		buf2 = (char*)buf1;
		 if( *buf2!='}') {buf1 = de( buf2 );  
		 /*if( *buf2!='}')*/ m_s1 = *(u8arr_t<8>*)buf2; }else return *this; 
		buf2 = (char*)buf1;
		 if( *buf2!='}') {buf1 = de( buf2 );  
		 /*if( *buf2!='}')*/ m_e_old = *(uiarr_t<long,335>*)buf2; }else return *this; 
		buf2 = (char*)buf1;
		 if( *buf2!='}') {buf1 = de( buf2 );  
		 /*if( *buf2!='}')*/ m_e = *(uiarr_t<long,335>*)buf2; }else return *this; 
		buf2 = (char*)buf1;
		 if( *buf2!='}') {buf1 = de( buf2 );  
		 /*if( *buf2!='}')*/ m_e_flag = *(uiarr_t<long,335>*)buf2; }else return *this; 
		buf2 = (char*)buf1;
		 if( *buf2!='}') {buf1 = de( buf2 );  
		 /*if( *buf2!='}')*/ m_RES = *(u8arr_t<23>*)buf2; }else return *this; 
		buf2 = (char*)buf1;
		 if( *buf2!='}') {buf1 = de( buf2 );  
		 /*if( *buf2!='}')*/ m_RES2 = *(uiarr_t<long,34>*)buf2; }else return *this; 
		return *this;
	}
	...
	a5041_t_rowtype & Unserialize( wl::tchar * p_begin, wl::tchar ** pp_end )
	{
		char *buf1 = p_begin;
		char *buf2;
		buf2 = (char*)buf1 + 4;
		...
		buf2 = (char*)buf1 + 4;
		buf1 = buf2 + *(wl::tuint32*)buf1;
		m_e_old = *(uiarr_t<long,335>*)buf2;
		buf2 = (char*)buf1 + 4;
		buf1 = buf2 + *(wl::tuint32*)buf1;
		m_e = *(uiarr_t<long,335>*)buf2;
		buf2 = (char*)buf1 + 4;
		buf1 = buf2 + *(wl::tuint32*)buf1;
		m_e_flag = *(uiarr_t<long,335>*)buf2;
		buf2 = (char*)buf1 + 4;
		buf1 = buf2 + *(wl::tuint32*)buf1;
		m_RES = *(u8arr_t<23>*)buf2;
		buf2 = (char*)buf1 + 4;
		buf1 = buf2 + *(wl::tuint32*)buf1;
		m_RES2 = *(uiarr_t<long,34>*)buf2;
		*pp_end = buf1;
		return *this;
	}
...
////////////////////////////////////////////////////////////////
//Function:	GetCol_s0
//Effect:	get ref of col. col is s0
//Return:	u8arr_t<8> & 
	u8arr_t<8> & GetCol_s0(void)
	{
		return m_s0;
	}
...
///////////////////////////////////////////////////////////////
//Function:	GetCol_s1
//Effect:	get ref of col. col is s1
//Return:	u8arr_t<8> & 
	u8arr_t<8> & GetCol_s1(void)
	{
		return m_s1;
	}

////////////////////////////////////////////////////////
//Function:	GetCol_e_old
//Effect:	get ref of col. col is e_old
//Return:	uiarr_t<long,335> & 
	uiarr_t<long,335> & GetCol_e_old(void)
	{
		return m_e_old;
	}
...
////////////////////////////////////////////////////////////////
//Function:	GetCol_e
//Effect:	get ref of col. col is e
//Return:	uiarr_t<long,335> & 
	uiarr_t<long,335> & GetCol_e(void)
	{
		return m_e;
	}

//////////////////////////////////////////////////////////////
//Function:	GetCol_e_flag
//Effect:	get ref of col. col is e_flag
//Return:	uiarr_t<long,335> & 
	uiarr_t<long,335> & GetCol_e_flag(void)
	{
		return m_e_flag;
	}
...
////////////////////////////////////////////////////////////
//Function:	GetCol_RES
//Effect:	get ref of col. col is RES
//Return:	u8arr_t<23> & 
	u8arr_t<23> & GetCol_RES(void)
	{
		return m_RES;
	}

//////////////////////////////////////////////////////////
//Function:	GetCol_RES2
//Effect:	get ref of col. col is RES2
//Return:	uiarr_t<long,34> & 
	uiarr_t<long,34> & GetCol_RES2(void)
	{
		return m_RES2;
	}
...
//Return:	return col value in string format.
	...
	STRINGT GetColStr( int iColNum )
	{
		...
		if( iColNum == 7 )
		{
			return wl::SStrf::b2s(m_s0);
		}
		if( iColNum == 8 )
		{
			return wl::SStrf::b2s(m_s1);
		}
		if( iColNum == 9 )
		{
			return wl::SStrf::b2s(m_e_old);
		}
		if( iColNum == 10 )
		{
			return wl::SStrf::b2s(m_e);
		}
		if( iColNum == 11 )
		{
			return wl::SStrf::b2s(m_e_flag);
		}
		if( iColNum == 12 )
		{
			return wl::SStrf::b2s(m_RES);
		}
		if( iColNum == 13 )
		{
			return wl::SStrf::b2s(m_RES2);
		}
...
//Return:	no return.
	...
	void SetColVal( int iColNum, STRINGT strValPARA )
	{
		...
		if( iColNum == 7 )
		{
			wl::SStrf::s2b(strValPARA,m_s0);
		}
		if( iColNum == 8 )
		{
			wl::SStrf::s2b(strValPARA,m_s1);
		}
		if( iColNum == 9 )
		{
			wl::SStrf::s2b(strValPARA,m_e_old);
		}
		if( iColNum == 10 )
		{
			wl::SStrf::s2b(strValPARA,m_e);
		}
		if( iColNum == 11 )
		{
			wl::SStrf::s2b(strValPARA,m_e_flag);
		}
		if( iColNum == 12 )
		{
			wl::SStrf::s2b(strValPARA,m_RES);
		}
		if( iColNum == 13 )
		{
			wl::SStrf::s2b(strValPARA,m_RES2);
		}
	}
...
private:
	...
	a5041_t_rowtype m_EmptyRow;
	std::vector<a5041_t_rowtype>  m_DATAcorpora;
 
public:

	typedef a5041_t_rowtype 	ROWTYPE;
	typedef std::vector<long> 	RPSTYPE; //RPS(return pointer set) type definition
	typedef std::vector<a5041_t_rowtype>::iterator 	TBLITTYPE;
...
public:
	...
	//operator == 
	bool operator == (const a5041_t & rhs) const
	{
		return this == &rhs;
	}
...
public:
	...
	a5041_t &  Unserialize( const char * strIn , int biAppend = 0 ) //if append==0, it would over-write the current tbl. 
	{
		char *p1,*p2;
		p1 = (char*)strIn;
		if(biAppend==0) Clear();
	...
	a5041_t & Unserialize( wl::SCake & ckIn , int biAppend = 0 )
	{
		char *p1,*p2;
		p1 = p2 = (char*)ckIn.buf();
		if(biAppend==0) Clear();
...
//Return:	a5041_t_rowtype&
	a5041_t_rowtype & GetRow(long lRowNum)
	{
		if(lRowNum>=0&&lRowNum<(long)m_DATAcorpora.size())
		return m_DATAcorpora[lRowNum];
		else 
		{
			a5041_t_rowtype tmpEmptyrow;
...
//Return:	a5041_t_rowtype&
	a5041_t_rowtype & GetRow(const std::vector<long> & vRps, long lRowNum)
	{
		long ltmp;
		do{
		{
...
//Return:	no return
	void Add(const a5041_t_rowtype & varRow)
	{
...
//Return:	a5041_t_rowtype&
	a5041_t_rowtype & SelE1_strTblName(std::string strVal) 
	{
...
//Effect:	select 1st row where col=val, or return default row.
//Return:	a5041_t_rowtype&
	a5041_t_rowtype & SelE1_lVer(long iVal) 
	{
		std::vector<long> vRps ;
		SelE_lVer( iVal, vRps );
		return GetRow( vRps, 0 );
...
//Effect:	select 1st row where col=val, or return default row.
//Return:	a5041_t_rowtype&
	a5041_t_rowtype & SelE1_strAffectDateTime(std::string strVal) 
	{
		std::vector<long> vRps ;
...
//Effect:	select 1st row where col=val, or return default row.
//Return:	a5041_t_rowtype&
	a5041_t_rowtype & SelE1_biDelFlag(wl::tuint8 iVal) 
	{
		std::vector<long> vRps ;
...
//Effect:	select 1st row where col=val, or return default row.
//Return:	a5041_t_rowtype&
	a5041_t_rowtype & SelE1_biIsAffect(wl::tuint8 iVal) 
	{
		std::vector<long> vRps ;
...
//Effect:	select 1st row where col=val, or return default row.
//Return:	a5041_t_rowtype&
	a5041_t_rowtype & SelE1_strStampDateTime(std::string strVal) 
	{
		std::vector<long> vRps ;
...
//Effect:	select 1st row where col=val, or return default row.
//Return:	a5041_t_rowtype&
	a5041_t_rowtype & SelE1_strDataRef(std::string strVal) 
	{
		std::vector<long> vRps ;
...
//Effect:	select and build RPS where col=val use traverse
//Return:	no return
	void SelE_s0(u8arr_t<8> aVal, std::vector<long> & vRps, std::vector<long> * pRefRps=NULL) //(ni)
	{
		for(long ltmp=0;ltmp<(long)m_DATAcorpora.size();ltmp++)
		if(m_DATAcorpora[ltmp].m_s0==aVal)
		if( !pRefRps || !pRefRps->empty() && std::binary_search( pRefRps->begin(), pRefRps->end(), ltmp ) ) vRps.push_back( ltmp );
	}
...
//Effect:	select 1st row where col=val, or return default row.
//Return:	a5041_t_rowtype&
	a5041_t_rowtype & SelE1_s0(u8arr_t<8> aVal) 
	{
		std::vector<long> vRps ;
		SelE_s0( aVal, vRps );
		return GetRow( vRps, 0 );
...
//Effect:	select and build RPS where col=val. clear rps first.
//Return:	no return
	void SelEc_s0(u8arr_t<8> aVal, std::vector<long> & vRps, std::vector<long> * pRefRps=NULL) //()
	{
		vRps.clear();
		SelE_s0(aVal, vRps, pRefRps);
	}
...
//Effect:	select and build RPS where col=val use traverse
//Return:	no return
	void SelE_s1(u8arr_t<8> aVal, std::vector<long> & vRps, std::vector<long> * pRefRps=NULL) //(ni)
	{
		for(long ltmp=0;ltmp<(long)m_DATAcorpora.size();ltmp++)
		if(m_DATAcorpora[ltmp].m_s1==aVal)
		if( !pRefRps || !pRefRps->empty() && std::binary_search( pRefRps->begin(), pRefRps->end(), ltmp ) ) vRps.push_back( ltmp );
	}
...
//Effect:	select 1st row where col=val, or return default row.
//Return:	a5041_t_rowtype&
	a5041_t_rowtype & SelE1_s1(u8arr_t<8> aVal) 
	{
		std::vector<long> vRps ;
		SelE_s1( aVal, vRps );
		return GetRow( vRps, 0 );
...
//Effect:	select and build RPS where col=val. clear rps first.
//Return:	no return
	void SelEc_s1(u8arr_t<8> aVal, std::vector<long> & vRps, std::vector<long> * pRefRps=NULL) //()
	{
		vRps.clear();
		SelE_s1(aVal, vRps, pRefRps);
	}
...
//Effect:	select and build RPS where col=val use traverse
//Return:	no return
	void SelE_e_old(uiarr_t<long,335> aVal, std::vector<long> & vRps, std::vector<long> * pRefRps=NULL) //(ni)
	{
		for(long ltmp=0;ltmp<(long)m_DATAcorpora.size();ltmp++)
		if(m_DATAcorpora[ltmp].m_e_old==aVal)
		if( !pRefRps || !pRefRps->empty() && std::binary_search( pRefRps->begin(), pRefRps->end(), ltmp ) ) vRps.push_back( ltmp );
	}

////////////////////////////////////////////////////////
//Function:	SelE1_e_old
//Effect:	select 1st row where col=val, or return default row.
//Return:	a5041_t_rowtype&
	a5041_t_rowtype & SelE1_e_old(uiarr_t<long,335> aVal) 
	{
		std::vector<long> vRps ;
		SelE_e_old( aVal, vRps );
		return GetRow( vRps, 0 );
	}

//////////////////////////////////////////////////////////////
//Function:	SelEc_e_old
//Effect:	select and build RPS where col=val. clear rps first.
//Return:	no return
	void SelEc_e_old(uiarr_t<long,335> aVal, std::vector<long> & vRps, std::vector<long> * pRefRps=NULL) //()
	{
		vRps.clear();
		SelE_e_old(aVal, vRps, pRefRps);
	}
...
//Effect:	select and build RPS where col=val use traverse
//Return:	no return
	void SelE_e(uiarr_t<long,335> aVal, std::vector<long> & vRps, std::vector<long> * pRefRps=NULL) //(ni)
	{
		for(long ltmp=0;ltmp<(long)m_DATAcorpora.size();ltmp++)
		if(m_DATAcorpora[ltmp].m_e==aVal)
		if( !pRefRps || !pRefRps->empty() && std::binary_search( pRefRps->begin(), pRefRps->end(), ltmp ) ) vRps.push_back( ltmp );
	}
...
//Effect:	select 1st row where col=val, or return default row.
//Return:	a5041_t_rowtype&
	a5041_t_rowtype & SelE1_e(uiarr_t<long,335> aVal) 
	{
		std::vector<long> vRps ;
		SelE_e( aVal, vRps );
		return GetRow( vRps, 0 );
...
//Effect:	select and build RPS where col=val. clear rps first.
//Return:	no return
	void SelEc_e(uiarr_t<long,335> aVal, std::vector<long> & vRps, std::vector<long> * pRefRps=NULL) //()
	{
		vRps.clear();
		SelE_e(aVal, vRps, pRefRps);
	}

//////////////////////////////////////////////////////////
//Function:	SelE_e_flag
//Effect:	select and build RPS where col=val use traverse
//Return:	no return
	void SelE_e_flag(uiarr_t<long,335> aVal, std::vector<long> & vRps, std::vector<long> * pRefRps=NULL) //(ni)
	{
		for(long ltmp=0;ltmp<(long)m_DATAcorpora.size();ltmp++)
		if(m_DATAcorpora[ltmp].m_e_flag==aVal)
		if( !pRefRps || !pRefRps->empty() && std::binary_search( pRefRps->begin(), pRefRps->end(), ltmp ) ) vRps.push_back( ltmp );
	}

//////////////////////////////////////////////////////////
//Function:	SelE1_e_flag
//Effect:	select 1st row where col=val, or return default row.
//Return:	a5041_t_rowtype&
	a5041_t_rowtype & SelE1_e_flag(uiarr_t<long,335> aVal) 
	{
		std::vector<long> vRps ;
		SelE_e_flag( aVal, vRps );
		return GetRow( vRps, 0 );
	}

/////////////////////////////////////////////////////////////
//Function:	SelEc_e_flag
//Effect:	select and build RPS where col=val. clear rps first.
//Return:	no return
	void SelEc_e_flag(uiarr_t<long,335> aVal, std::vector<long> & vRps, std::vector<long> * pRefRps=NULL) //()
	{
		vRps.clear();
		SelE_e_flag(aVal, vRps, pRefRps);
	}
...
//Effect:	select and build RPS where col=val use traverse
//Return:	no return
	void SelE_RES(u8arr_t<23> aVal, std::vector<long> & vRps, std::vector<long> * pRefRps=NULL) //(ni)
	{
		for(long ltmp=0;ltmp<(long)m_DATAcorpora.size();ltmp++)
		if(m_DATAcorpora[ltmp].m_RES==aVal)
		if( !pRefRps || !pRefRps->empty() && std::binary_search( pRefRps->begin(), pRefRps->end(), ltmp ) ) vRps.push_back( ltmp );
	}
...
//Effect:	select 1st row where col=val, or return default row.
//Return:	a5041_t_rowtype&
	a5041_t_rowtype & SelE1_RES(u8arr_t<23> aVal) 
	{
		std::vector<long> vRps ;
		SelE_RES( aVal, vRps );
		return GetRow( vRps, 0 );
...
//Effect:	select and build RPS where col=val. clear rps first.
//Return:	no return
	void SelEc_RES(u8arr_t<23> aVal, std::vector<long> & vRps, std::vector<long> * pRefRps=NULL) //()
	{
		vRps.clear();
		SelE_RES(aVal, vRps, pRefRps);
	}
...
//Effect:	select and build RPS where col=val use traverse
//Return:	no return
	void SelE_RES2(uiarr_t<long,34> aVal, std::vector<long> & vRps, std::vector<long> * pRefRps=NULL) //(ni)
	{
		for(long ltmp=0;ltmp<(long)m_DATAcorpora.size();ltmp++)
		if(m_DATAcorpora[ltmp].m_RES2==aVal)
		if( !pRefRps || !pRefRps->empty() && std::binary_search( pRefRps->begin(), pRefRps->end(), ltmp ) ) vRps.push_back( ltmp );
	}
...
//Effect:	select 1st row where col=val, or return default row.
//Return:	a5041_t_rowtype&
	a5041_t_rowtype & SelE1_RES2(uiarr_t<long,34> aVal) 
	{
		std::vector<long> vRps ;
		SelE_RES2( aVal, vRps );
		return GetRow( vRps, 0 );
...
//Effect:	select and build RPS where col=val. clear rps first.
//Return:	no return
	void SelEc_RES2(uiarr_t<long,34> aVal, std::vector<long> & vRps, std::vector<long> * pRefRps=NULL) //()
	{
		vRps.clear();
		SelE_RES2(aVal, vRps, pRefRps);
	}
