...
#ifndef V1_3AA3000_T_20140523_152524
#define V1_3AA3000_T_20140523_152524

 
///////////////////////////////////////////////////////
//Contents:	The row class type definition of a3000_t
//Name:	a3000_t_rowtype
class a3000_t_rowtype {
 
public:

	std::string		m_strTblName;			// 1		a3000 
	long		m_lVer;			// 2		参数版本 
	...
	u8arr_t<4>		m_BeginNode;			// a	1	发起方节点标识码 命令发起方 Block 4 
	u8arr_t<4>		m_RunNode;			// a	2	执行方节点标识码 命令执行方 Block 4 
	wl::tuint8		m_uiCmdCode;			// a	3	命令代码 见本部分2.0.4 Byte 1 
	long		m_lOperatorNum;			// a	4	操作员编号 发起者 Long 4 
	wl::tuint8		m_iRunned;			// a	5	执行过 
	wl::tuint8		m_RES01;			// a	6	[保留] 
	u8arr_t<2>		m_RES02;			// a	7	[保留] 
	wl::tuint8		m_RES03;			// a	8	[保留] 
...
public:
	...
	a3000_t_rowtype()
	{
		...
		m_strDataRef = "";
		//m_BeginNode = //use default
		//m_RunNode = //use default
		m_uiCmdCode = 0;
		m_lOperatorNum = 0;
		m_iRunned = 0;
		m_RES01 = 0;
	...
	virtual ~a3000_t_rowtype(){;}
	

	//operator == 
	bool operator == (const a3000_t_rowtype & rhs) const
	{
		return this == &rhs;
	}
...
public:
	...
	std::string & Serialize( std::string & strOut )
	{
		...
		strOut += std::string(buf2);
		strOut += std::string("/");
		buf1 = (const char *)reinterpret_cast<char *>(&reinterpret_cast<char&>(m_BeginNode));
		len1 = sizeof(m_BeginNode);
		if( (int)v.size() < ( len1 * 2 + 4 ) ) v.resize( len1 * 2 + 4 );
		buf2 = (char*)(&(v[0]));
		en( buf1, len1, buf2 );
		strOut += std::string(buf2);
		strOut += std::string("/");
		buf1 = (const char *)reinterpret_cast<char *>(&reinterpret_cast<char&>(m_RunNode));
		len1 = sizeof(m_RunNode);
		if( (int)v.size() < ( len1 * 2 + 4 ) ) v.resize( len1 * 2 + 4 );
		buf2 = (char*)(&(v[0]));
		en( buf1, len1, buf2 );
		strOut += std::string(buf2);
		strOut += std::string("/");
		buf1 = (const char *)reinterpret_cast<char *>(&reinterpret_cast<char&>(m_uiCmdCode));
		len1 = sizeof(m_uiCmdCode);
		if( (int)v.size() < ( len1 * 2 + 4 ) ) v.resize( len1 * 2 + 4 );
		buf2 = (char*)(&(v[0]));
		en( buf1, len1, buf2 );
		strOut += std::string(buf2);
		...
		strOut += std::string(buf2);
		strOut += std::string("/");
		buf1 = (const char *)reinterpret_cast<char *>(&reinterpret_cast<char&>(m_iRunned));
		len1 = sizeof(m_iRunned);
		if( (int)v.size() < ( len1 * 2 + 4 ) ) v.resize( len1 * 2 + 4 );
		buf2 = (char*)(&(v[0]));
		en( buf1, len1, buf2 );
		strOut += std::string(buf2);
	...
	a3000_t_rowtype & Unserialize( const char * strIn )
	{
		const char *buf1;
		char *buf2;
		buf1 = strIn;
		...
		buf2 = (char*)buf1;
		 if( *buf2!='}') {buf1 = de( buf2 );  
		 /*if( *buf2!='}')*/ m_BeginNode = *(u8arr_t<4>*)buf2; }else return *this; 
		buf2 = (char*)buf1;
		 if( *buf2!='}') {buf1 = de( buf2 );  
		 /*if( *buf2!='}')*/ m_RunNode = *(u8arr_t<4>*)buf2; }else return *this; 
		buf2 = (char*)buf1;
		 if( *buf2!='}') {buf1 = de( buf2 );  
		 /*if( *buf2!='}')*/ m_uiCmdCode = *(wl::tuint8*)buf2; }else return *this; 
		buf2 = (char*)buf1;
		 if( *buf2!='}') {buf1 = de( buf2 );  
		 /*if( *buf2!='}')*/ m_lOperatorNum = *(long*)buf2; }else return *this; 
		buf2 = (char*)buf1;
		 if( *buf2!='}') {buf1 = de( buf2 );  
		 /*if( *buf2!='}')*/ m_iRunned = *(wl::tuint8*)buf2; }else return *this; 
		buf2 = (char*)buf1;
		 if( *buf2!='}') {buf1 = de( buf2 );  
	...
	a3000_t_rowtype & Unserialize( wl::tchar * p_begin, wl::tchar ** pp_end )
	{
		char *buf1 = p_begin;
		char *buf2;
		buf2 = (char*)buf1 + 4;
		...
		buf2 = (char*)buf1 + 4;
		buf1 = buf2 + *(wl::tuint32*)buf1;
		m_BeginNode = *(u8arr_t<4>*)buf2;
		buf2 = (char*)buf1 + 4;
		buf1 = buf2 + *(wl::tuint32*)buf1;
		m_RunNode = *(u8arr_t<4>*)buf2;
		buf2 = (char*)buf1 + 4;
		buf1 = buf2 + *(wl::tuint32*)buf1;
		m_uiCmdCode = *(wl::tuint8*)buf2;
		buf2 = (char*)buf1 + 4;
		buf1 = buf2 + *(wl::tuint32*)buf1;
		m_lOperatorNum = *(long*)buf2;
		buf2 = (char*)buf1 + 4;
		buf1 = buf2 + *(wl::tuint32*)buf1;
		m_iRunned = *(wl::tuint8*)buf2;
		buf2 = (char*)buf1 + 4;
		buf1 = buf2 + *(wl::tuint32*)buf1;
...
////////////////////////////////////////////////////////////////
//Function:	GetCol_BeginNode
//Effect:	get ref of col. col is BeginNode
//Return:	u8arr_t<4> & 
	u8arr_t<4> & GetCol_BeginNode(void)
	{
		return m_BeginNode;
	}

///////////////////////////////////////////////////////////////
//Function:	GetCol_RunNode
//Effect:	get ref of col. col is RunNode
//Return:	u8arr_t<4> & 
	u8arr_t<4> & GetCol_RunNode(void)
	{
		return m_RunNode;
	}

////////////////////////////////////////////////////////
//Function:	GetCol_uiCmdCode
//Effect:	get ref of col. col is uiCmdCode
//Return:	wl::tuint8 & 
	wl::tuint8 & GetCol_uiCmdCode(void)
	{
		return m_uiCmdCode;
	}
...
//////////////////////////////////////////////////////////////
//Function:	GetCol_iRunned
//Effect:	get ref of col. col is iRunned
//Return:	wl::tuint8 & 
	wl::tuint8 & GetCol_iRunned(void)
	{
		return m_iRunned;
	}
...
//Return:	return the column number, int.
	int GetColNumber( std::string strColName ) 
	{
		...
		if( strColName == "BeginNode" )
		{
			return 7;
		}
		if( strColName == "RunNode" )
		{
			return 8;
		}
		if( strColName == "uiCmdCode" )
		{
			return 9;
		}
...
//Return:	return col value in string format.
	...
	STRINGT GetColStr( int iColNum )
	{
		...
		if( iColNum == 7 )
		{
			return wl::SStrf::b2s(m_BeginNode);
		}
		if( iColNum == 8 )
		{
			return wl::SStrf::b2s(m_RunNode);
		}
		if( iColNum == 9 )
		{
			return wl::SStrf::sltoa(m_uiCmdCode);
		}
		if( iColNum == 10 )
		{
		...
		if( iColNum == 11 )
		{
			return wl::SStrf::sltoa(m_iRunned);
		}
		if( iColNum == 12 )
		{
...
//Return:	no return.
	...
	void SetColVal( int iColNum, STRINGT strValPARA )
	{
		...
		if( iColNum == 7 )
		{
			wl::SStrf::s2b(strValPARA,m_BeginNode);
		}
		if( iColNum == 8 )
		{
			wl::SStrf::s2b(strValPARA,m_RunNode);
		}
		if( iColNum == 9 )
		{
			m_uiCmdCode=(wl::tuint8)wl::SStrf::satol(strValPARA);
		}
		if( iColNum == 10 )
		{
		...
		if( iColNum == 11 )
		{
			m_iRunned=(wl::tuint8)wl::SStrf::satol(strValPARA);
		}
		if( iColNum == 12 )
		{
...
private:
	...
	a3000_t_rowtype m_EmptyRow;
	std::vector<a3000_t_rowtype>  m_DATAcorpora;
 
public:

	typedef a3000_t_rowtype 	ROWTYPE;
	typedef std::vector<long> 	RPSTYPE; //RPS(return pointer set) type definition
	typedef std::vector<a3000_t_rowtype>::iterator 	TBLITTYPE;
...
public:
	...
	//operator == 
	bool operator == (const a3000_t & rhs) const
	{
		return this == &rhs;
	}
...
public:
	...
	a3000_t &  Unserialize( const char * strIn , int biAppend = 0 ) //if append==0, it would over-write the current tbl. 
	{
		char *p1,*p2;
		p1 = (char*)strIn;
		if(biAppend==0) Clear();
	...
	a3000_t & Unserialize( wl::SCake & ckIn , int biAppend = 0 )
	{
		char *p1,*p2;
		p1 = p2 = (char*)ckIn.buf();
		if(biAppend==0) Clear();
...
//Return:	a3000_t_rowtype&
	a3000_t_rowtype & GetRow(long lRowNum)
	{
		if(lRowNum>=0&&lRowNum<(long)m_DATAcorpora.size())
		return m_DATAcorpora[lRowNum];
		else 
		{
			a3000_t_rowtype tmpEmptyrow;
...
//Return:	a3000_t_rowtype&
	a3000_t_rowtype & GetRow(const std::vector<long> & vRps, long lRowNum)
	{
		long ltmp;
		do{
		{
...
//Return:	no return
	void Add(const a3000_t_rowtype & varRow)
	{
...
//Return:	a3000_t_rowtype&
	a3000_t_rowtype & SelE1_strTblName(std::string strVal) 
	{
...
//Effect:	select 1st row where col=val, or return default row.
//Return:	a3000_t_rowtype&
	a3000_t_rowtype & SelE1_lVer(long iVal) 
	{
		std::vector<long> vRps ;
		SelE_lVer( iVal, vRps );
		return GetRow( vRps, 0 );
...
//Effect:	select 1st row where col=val, or return default row.
//Return:	a3000_t_rowtype&
	a3000_t_rowtype & SelE1_strAffectDateTime(std::string strVal) 
	{
		std::vector<long> vRps ;
...
//Effect:	select 1st row where col=val, or return default row.
//Return:	a3000_t_rowtype&
	a3000_t_rowtype & SelE1_biDelFlag(wl::tuint8 iVal) 
	{
		std::vector<long> vRps ;
...
//Effect:	select 1st row where col=val, or return default row.
//Return:	a3000_t_rowtype&
	a3000_t_rowtype & SelE1_biIsAffect(wl::tuint8 iVal) 
	{
		std::vector<long> vRps ;
...
//Effect:	select 1st row where col=val, or return default row.
//Return:	a3000_t_rowtype&
	a3000_t_rowtype & SelE1_strStampDateTime(std::string strVal) 
	{
		std::vector<long> vRps ;
...
//Effect:	select 1st row where col=val, or return default row.
//Return:	a3000_t_rowtype&
	a3000_t_rowtype & SelE1_strDataRef(std::string strVal) 
	{
		std::vector<long> vRps ;
...
/////////////////////////////////////////////////////////////
//Function:	SelE_BeginNode
//Effect:	select and build RPS where col=val use traverse
//Return:	no return
	void SelE_BeginNode(u8arr_t<4> aVal, std::vector<long> & vRps, std::vector<long> * pRefRps=NULL) //(ni)
	{
		for(long ltmp=0;ltmp<(long)m_DATAcorpora.size();ltmp++)
		if(m_DATAcorpora[ltmp].m_BeginNode==aVal)
		if( !pRefRps || !pRefRps->empty() && std::binary_search( pRefRps->begin(), pRefRps->end(), ltmp ) ) vRps.push_back( ltmp );
	}

///////////////////////////////////////////////////////////
//Function:	SelE1_BeginNode
//Effect:	select 1st row where col=val, or return default row.
//Return:	a3000_t_rowtype&
	a3000_t_rowtype & SelE1_BeginNode(u8arr_t<4> aVal) 
	{
		std::vector<long> vRps ;
		SelE_BeginNode( aVal, vRps );
		return GetRow( vRps, 0 );
	}

/////////////////////////////////////////////////////////
//Function:	SelEc_BeginNode
//Effect:	select and build RPS where col=val. clear rps first.
//Return:	no return
	void SelEc_BeginNode(u8arr_t<4> aVal, std::vector<long> & vRps, std::vector<long> * pRefRps=NULL) //()
	{
		vRps.clear();
		SelE_BeginNode(aVal, vRps, pRefRps);
	}

//////////////////////////////////////////////////////////
//Function:	SelE_RunNode
//Effect:	select and build RPS where col=val use traverse
//Return:	no return
	void SelE_RunNode(u8arr_t<4> aVal, std::vector<long> & vRps, std::vector<long> * pRefRps=NULL) //(ni)
	{
		for(long ltmp=0;ltmp<(long)m_DATAcorpora.size();ltmp++)
		if(m_DATAcorpora[ltmp].m_RunNode==aVal)
		if( !pRefRps || !pRefRps->empty() && std::binary_search( pRefRps->begin(), pRefRps->end(), ltmp ) ) vRps.push_back( ltmp );
	}

////////////////////////////////////////////////////////////////
//Function:	SelE1_RunNode
//Effect:	select 1st row where col=val, or return default row.
//Return:	a3000_t_rowtype&
	a3000_t_rowtype & SelE1_RunNode(u8arr_t<4> aVal) 
	{
		std::vector<long> vRps ;
		SelE_RunNode( aVal, vRps );
		return GetRow( vRps, 0 );
	}

///////////////////////////////////////////////////////
//Function:	SelEc_RunNode
//Effect:	select and build RPS where col=val. clear rps first.
//Return:	no return
	void SelEc_RunNode(u8arr_t<4> aVal, std::vector<long> & vRps, std::vector<long> * pRefRps=NULL) //()
	{
		vRps.clear();
		SelE_RunNode(aVal, vRps, pRefRps);
	}

///////////////////////////////////////////////////////////
//Function:	SelE_uiCmdCode
//Effect:	select and build RPS where col=val use traverse
//Return:	no return
	void SelE_uiCmdCode(wl::tuint8 iVal, std::vector<long> & vRps, std::vector<long> * pRefRps=NULL) //(ni)
	{
		for(long ltmp=0;ltmp<(long)m_DATAcorpora.size();ltmp++)
		if(m_DATAcorpora[ltmp].m_uiCmdCode==iVal)
		if( !pRefRps || !pRefRps->empty() && std::binary_search( pRefRps->begin(), pRefRps->end(), ltmp ) ) vRps.push_back( ltmp );
	}

////////////////////////////////////////////////////////
//Function:	SelE1_uiCmdCode
//Effect:	select 1st row where col=val, or return default row.
//Return:	a3000_t_rowtype&
	a3000_t_rowtype & SelE1_uiCmdCode(wl::tuint8 iVal) 
	{
		std::vector<long> vRps ;
		SelE_uiCmdCode( iVal, vRps );
		return GetRow( vRps, 0 );
	}

//////////////////////////////////////////////////////////////
//Function:	SelEc_uiCmdCode
//Effect:	select and build RPS where col=val. clear rps first.
//Return:	no return
	void SelEc_uiCmdCode(wl::tuint8 iVal, std::vector<long> & vRps, std::vector<long> * pRefRps=NULL) //()
	{
		vRps.clear();
		SelE_uiCmdCode(iVal, vRps, pRefRps);
	}
...
//Effect:	select 1st row where col=val, or return default row.
//Return:	a3000_t_rowtype&
	a3000_t_rowtype & SelE1_lOperatorNum(long iVal) 
	{
		std::vector<long> vRps ;
...
//////////////////////////////////////////////////////////
//Function:	SelE_iRunned
//Effect:	select and build RPS where col=val use traverse
//Return:	no return
	void SelE_iRunned(wl::tuint8 iVal, std::vector<long> & vRps, std::vector<long> * pRefRps=NULL) //(ni)
	{
		for(long ltmp=0;ltmp<(long)m_DATAcorpora.size();ltmp++)
		if(m_DATAcorpora[ltmp].m_iRunned==iVal)
		if( !pRefRps || !pRefRps->empty() && std::binary_search( pRefRps->begin(), pRefRps->end(), ltmp ) ) vRps.push_back( ltmp );
	}

//////////////////////////////////////////////////////////
//Function:	SelE1_iRunned
//Effect:	select 1st row where col=val, or return default row.
//Return:	a3000_t_rowtype&
	a3000_t_rowtype & SelE1_iRunned(wl::tuint8 iVal) 
	{
		std::vector<long> vRps ;
		SelE_iRunned( iVal, vRps );
		return GetRow( vRps, 0 );
	}

/////////////////////////////////////////////////////////////
//Function:	SelEc_iRunned
//Effect:	select and build RPS where col=val. clear rps first.
//Return:	no return
	void SelEc_iRunned(wl::tuint8 iVal, std::vector<long> & vRps, std::vector<long> * pRefRps=NULL) //()
	{
		vRps.clear();
		SelE_iRunned(iVal, vRps, pRefRps);
	}
...
//Effect:	select 1st row where col=val, or return default row.
//Return:	a3000_t_rowtype&
	a3000_t_rowtype & SelE1_RES01(wl::tuint8 iVal) 
	{
		std::vector<long> vRps ;
...
//Effect:	select 1st row where col=val, or return default row.
//Return:	a3000_t_rowtype&
	a3000_t_rowtype & SelE1_RES02(u8arr_t<2> aVal) 
	{
		std::vector<long> vRps ;
...
//Effect:	select 1st row where col=val, or return default row.
//Return:	a3000_t_rowtype&
	a3000_t_rowtype & SelE1_RES03(wl::tuint8 iVal) 
	{
		std::vector<long> vRps ;
