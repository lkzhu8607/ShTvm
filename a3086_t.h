...
#ifndef V1_3AA3086_T_20140523_162453
#define V1_3AA3086_T_20140523_162453

 
///////////////////////////////////////////////////////
//Contents:	The row class type definition of a3086_t
//Name:	a3086_t_rowtype
class a3086_t_rowtype {
 
public:

	std::string		m_strTblName;			// 1		7.0.24  3086-TVM车站位图定义报文 
	long		m_lVer;			// 2		参数版本 
	...
	std::string		m_strPicPath;			// a	1	图片存放路径 上级节点存放图片文件的路径 String 64 
	std::string		m_strPicFn;			// a	2	线路车站图片文件名  String 16 
	u8arr_t<8>		m_PicChk;			// a	3	图片文件的校验 采用MD5算法生成摘要的前8字节 Block 8 
	u8arr_t<32>		m_RES_01;			// a	4	保留  BYTE 32 
	int		m_PkgDownloaded;			// a	5	是否已成功地用FTP下到文件 
...
public:
	...
	virtual ~a3086_t_rowtype(){;}
	

	//operator == 
	bool operator == (const a3086_t_rowtype & rhs) const
	{
		return this == &rhs;
	}
...
public:
	...
	std::string & Serialize( std::string & strOut )
	{
		...
		strOut += std::string(buf2);
		strOut += std::string("/");
		buf1 = (const char *)m_strPicPath.c_str();
		len1 = (long)(m_strPicPath.length()*sizeof(char)+sizeof(char));
		if( (int)v.size() < ( len1 * 2 + 4 ) ) v.resize( len1 * 2 + 4 );
		buf2 = (char*)(&(v[0]));
		en( buf1, len1, buf2 );
		strOut += std::string(buf2);
		...
		strOut += std::string(buf2);
		strOut += std::string("/");
		buf1 = (const char *)reinterpret_cast<char *>(&reinterpret_cast<char&>(m_PicChk));
		len1 = sizeof(m_PicChk);
		if( (int)v.size() < ( len1 * 2 + 4 ) ) v.resize( len1 * 2 + 4 );
		buf2 = (char*)(&(v[0]));
		en( buf1, len1, buf2 );
		strOut += std::string(buf2);
		...
		strOut += std::string(buf2);
		strOut += std::string("/");
		buf1 = (const char *)reinterpret_cast<char *>(&reinterpret_cast<char&>(m_PkgDownloaded));
		len1 = sizeof(m_PkgDownloaded);
		if( (int)v.size() < ( len1 * 2 + 4 ) ) v.resize( len1 * 2 + 4 );
		buf2 = (char*)(&(v[0]));
		en( buf1, len1, buf2 );
		strOut += std::string(buf2);
	...
	a3086_t_rowtype & Unserialize( const char * strIn )
	{
		const char *buf1;
		char *buf2;
		buf1 = strIn;
		...
		buf2 = (char*)buf1;
		 if( *buf2!='}') {buf1 = de( buf2 );  
		 /*if( *buf2!='}')*/ m_strPicPath = (char*)buf2; }else return *this; 
		buf2 = (char*)buf1;
		 if( *buf2!='}') {buf1 = de( buf2 );  
		 /*if( *buf2!='}')*/ m_strPicFn = (char*)buf2; }else return *this; 
		buf2 = (char*)buf1;
		 if( *buf2!='}') {buf1 = de( buf2 );  
		 /*if( *buf2!='}')*/ m_PicChk = *(u8arr_t<8>*)buf2; }else return *this; 
		buf2 = (char*)buf1;
		 if( *buf2!='}') {buf1 = de( buf2 );  
		 /*if( *buf2!='}')*/ m_RES_01 = *(u8arr_t<32>*)buf2; }else return *this; 
		buf2 = (char*)buf1;
		 if( *buf2!='}') {buf1 = de( buf2 );  
		 /*if( *buf2!='}')*/ m_PkgDownloaded = *(int*)buf2; }else return *this; 
		buf2 = (char*)buf1;
		 if( *buf2!='}') {buf1 = de( buf2 );  
	...
	a3086_t_rowtype & Unserialize( wl::tchar * p_begin, wl::tchar ** pp_end )
	{
		char *buf1 = p_begin;
		char *buf2;
		buf2 = (char*)buf1 + 4;
		...
		buf2 = (char*)buf1 + 4;
		buf1 = buf2 + *(wl::tuint32*)buf1;
		m_strPicPath = (char*)buf2;
		buf2 = (char*)buf1 + 4;
		buf1 = buf2 + *(wl::tuint32*)buf1;
		m_strPicFn = (char*)buf2;
		buf2 = (char*)buf1 + 4;
		buf1 = buf2 + *(wl::tuint32*)buf1;
		m_PicChk = *(u8arr_t<8>*)buf2;
		buf2 = (char*)buf1 + 4;
		buf1 = buf2 + *(wl::tuint32*)buf1;
		m_RES_01 = *(u8arr_t<32>*)buf2;
		buf2 = (char*)buf1 + 4;
		buf1 = buf2 + *(wl::tuint32*)buf1;
		m_PkgDownloaded = *(int*)buf2;
		buf2 = (char*)buf1 + 4;
		buf1 = buf2 + *(wl::tuint32*)buf1;
...
////////////////////////////////////////////////////////////////
//Function:	GetCol_strPicPath
//Effect:	get ref of col. col is strPicPath
//Return:	std::string & 
	std::string & GetCol_strPicPath(void)
	{
		return m_strPicPath;
	}
...
////////////////////////////////////////////////////////
//Function:	GetCol_PicChk
//Effect:	get ref of col. col is PicChk
//Return:	u8arr_t<8> & 
	u8arr_t<8> & GetCol_PicChk(void)
	{
		return m_PicChk;
	}
...
//////////////////////////////////////////////////////////////
//Function:	GetCol_PkgDownloaded
//Effect:	get ref of col. col is PkgDownloaded
//Return:	int & 
	int & GetCol_PkgDownloaded(void)
	{
		return m_PkgDownloaded;
	}
...
//Return:	return col value in string format.
	...
	STRINGT GetColStr( int iColNum )
	{
		...
		if( iColNum == 11 )
		{
			return wl::SStrf::sltoa(m_PkgDownloaded);
		}
		if( iColNum == 12 )
		{
...
//Return:	no return.
	...
	void SetColVal( int iColNum, STRINGT strValPARA )
	{
		...
		if( iColNum == 9 )
		{
			wl::SStrf::s2b(strValPARA,m_PicChk);
		}
		if( iColNum == 10 )
		{
		...
		if( iColNum == 11 )
		{
			m_PkgDownloaded=wl::SStrf::satol(strValPARA);
		}
		if( iColNum == 12 )
		{
...
private:
	...
	a3086_t_rowtype m_EmptyRow;
	std::vector<a3086_t_rowtype>  m_DATAcorpora;
 
public:

	typedef a3086_t_rowtype 	ROWTYPE;
	typedef std::vector<long> 	RPSTYPE; //RPS(return pointer set) type definition
	typedef std::vector<a3086_t_rowtype>::iterator 	TBLITTYPE;
...
public:
	...
	//operator == 
	bool operator == (const a3086_t & rhs) const
	{
		return this == &rhs;
	}
...
public:
	...
	a3086_t &  Unserialize( const char * strIn , int biAppend = 0 ) //if append==0, it would over-write the current tbl. 
	{
		char *p1,*p2;
		p1 = (char*)strIn;
		if(biAppend==0) Clear();
	...
	a3086_t & Unserialize( wl::SCake & ckIn , int biAppend = 0 )
	{
		char *p1,*p2;
		p1 = p2 = (char*)ckIn.buf();
		if(biAppend==0) Clear();
...
//Return:	a3086_t_rowtype&
	a3086_t_rowtype & GetRow(long lRowNum)
	{
		if(lRowNum>=0&&lRowNum<(long)m_DATAcorpora.size())
		return m_DATAcorpora[lRowNum];
		else 
		{
			a3086_t_rowtype tmpEmptyrow;
...
//Return:	a3086_t_rowtype&
	a3086_t_rowtype & GetRow(const std::vector<long> & vRps, long lRowNum)
	{
		long ltmp;
		do{
		{
...
//Return:	no return
	void Add(const a3086_t_rowtype & varRow)
	{
...
//Return:	a3086_t_rowtype&
	a3086_t_rowtype & SelE1_strTblName(std::string strVal) 
	{
...
//Effect:	select 1st row where col=val, or return default row.
//Return:	a3086_t_rowtype&
	a3086_t_rowtype & SelE1_lVer(long iVal) 
	{
		std::vector<long> vRps ;
		SelE_lVer( iVal, vRps );
		return GetRow( vRps, 0 );
...
//Effect:	select 1st row where col=val, or return default row.
//Return:	a3086_t_rowtype&
	a3086_t_rowtype & SelE1_strAffectDateTime(std::string strVal) 
	{
		std::vector<long> vRps ;
...
//Effect:	select 1st row where col=val, or return default row.
//Return:	a3086_t_rowtype&
	a3086_t_rowtype & SelE1_biDelFlag(wl::tuint8 iVal) 
	{
		std::vector<long> vRps ;
...
//Effect:	select 1st row where col=val, or return default row.
//Return:	a3086_t_rowtype&
	a3086_t_rowtype & SelE1_biIsAffect(wl::tuint8 iVal) 
	{
		std::vector<long> vRps ;
...
//Effect:	select 1st row where col=val, or return default row.
//Return:	a3086_t_rowtype&
	a3086_t_rowtype & SelE1_strStampDateTime(std::string strVal) 
	{
		std::vector<long> vRps ;
...
//Effect:	select 1st row where col=val, or return default row.
//Return:	a3086_t_rowtype&
	a3086_t_rowtype & SelE1_strDataRef(std::string strVal) 
	{
		std::vector<long> vRps ;
...
/////////////////////////////////////////////////////////////
//Function:	SelE_strPicPath
//Effect:	select and build RPS where col=val use traverse
//Return:	no return
	void SelE_strPicPath(std::string strVal, std::vector<long> & vRps, std::vector<long> * pRefRps=NULL) //(ni)
	{
		for(long ltmp=0;ltmp<(long)m_DATAcorpora.size();ltmp++)
		if(m_DATAcorpora[ltmp].m_strPicPath==strVal)
		if( !pRefRps || !pRefRps->empty() && std::binary_search( pRefRps->begin(), pRefRps->end(), ltmp ) ) vRps.push_back( ltmp );
	}

///////////////////////////////////////////////////////////
//Function:	SelE1_strPicPath
//Effect:	select 1st row where col=val, or return default row.
//Return:	a3086_t_rowtype&
	a3086_t_rowtype & SelE1_strPicPath(std::string strVal) 
	{
		std::vector<long> vRps ;
		SelE_strPicPath( strVal, vRps );
		return GetRow( vRps, 0 );
	}

/////////////////////////////////////////////////////////
//Function:	SelEc_strPicPath
//Effect:	select and build RPS where col=val. clear rps first.
//Return:	no return
	void SelEc_strPicPath(std::string strVal, std::vector<long> & vRps, std::vector<long> * pRefRps=NULL) //()
	{
		vRps.clear();
		SelE_strPicPath(strVal, vRps, pRefRps);
	}
...
//Effect:	select 1st row where col=val, or return default row.
//Return:	a3086_t_rowtype&
	a3086_t_rowtype & SelE1_strPicFn(std::string strVal) 
	{
		std::vector<long> vRps ;
...
///////////////////////////////////////////////////////////
//Function:	SelE_PicChk
//Effect:	select and build RPS where col=val use traverse
//Return:	no return
	void SelE_PicChk(u8arr_t<8> aVal, std::vector<long> & vRps, std::vector<long> * pRefRps=NULL) //(ni)
	{
		for(long ltmp=0;ltmp<(long)m_DATAcorpora.size();ltmp++)
		if(m_DATAcorpora[ltmp].m_PicChk==aVal)
		if( !pRefRps || !pRefRps->empty() && std::binary_search( pRefRps->begin(), pRefRps->end(), ltmp ) ) vRps.push_back( ltmp );
	}

////////////////////////////////////////////////////////
//Function:	SelE1_PicChk
//Effect:	select 1st row where col=val, or return default row.
//Return:	a3086_t_rowtype&
	a3086_t_rowtype & SelE1_PicChk(u8arr_t<8> aVal) 
	{
		std::vector<long> vRps ;
		SelE_PicChk( aVal, vRps );
		return GetRow( vRps, 0 );
	}

//////////////////////////////////////////////////////////////
//Function:	SelEc_PicChk
//Effect:	select and build RPS where col=val. clear rps first.
//Return:	no return
	void SelEc_PicChk(u8arr_t<8> aVal, std::vector<long> & vRps, std::vector<long> * pRefRps=NULL) //()
	{
		vRps.clear();
		SelE_PicChk(aVal, vRps, pRefRps);
	}
...
//Effect:	select 1st row where col=val, or return default row.
//Return:	a3086_t_rowtype&
	a3086_t_rowtype & SelE1_RES_01(u8arr_t<32> aVal) 
	{
		std::vector<long> vRps ;
...
//////////////////////////////////////////////////////////
//Function:	SelE_PkgDownloaded
//Effect:	select and build RPS where col=val use traverse
//Return:	no return
	void SelE_PkgDownloaded(int iVal, std::vector<long> & vRps, std::vector<long> * pRefRps=NULL) //(ni)
	{
		for(long ltmp=0;ltmp<(long)m_DATAcorpora.size();ltmp++)
		if(m_DATAcorpora[ltmp].m_PkgDownloaded==iVal)
		if( !pRefRps || !pRefRps->empty() && std::binary_search( pRefRps->begin(), pRefRps->end(), ltmp ) ) vRps.push_back( ltmp );
	}

//////////////////////////////////////////////////////////
//Function:	SelE1_PkgDownloaded
//Effect:	select 1st row where col=val, or return default row.
//Return:	a3086_t_rowtype&
	a3086_t_rowtype & SelE1_PkgDownloaded(int iVal) 
	{
		std::vector<long> vRps ;
		SelE_PkgDownloaded( iVal, vRps );
		return GetRow( vRps, 0 );
	}

/////////////////////////////////////////////////////////////
//Function:	SelEc_PkgDownloaded
//Effect:	select and build RPS where col=val. clear rps first.
//Return:	no return
	void SelEc_PkgDownloaded(int iVal, std::vector<long> & vRps, std::vector<long> * pRefRps=NULL) //()
	{
		vRps.clear();
		SelE_PkgDownloaded(iVal, vRps, pRefRps);
	}
...
//Effect:	select 1st row where col=val, or return default row.
//Return:	a3086_t_rowtype&
	a3086_t_rowtype & SelE1_RES01(wl::tuint8 iVal) 
	{
		std::vector<long> vRps ;
...
//Effect:	select 1st row where col=val, or return default row.
//Return:	a3086_t_rowtype&
	a3086_t_rowtype & SelE1_RES02(u8arr_t<2> aVal) 
	{
		std::vector<long> vRps ;
...
//Effect:	select 1st row where col=val, or return default row.
//Return:	a3086_t_rowtype&
	a3086_t_rowtype & SelE1_RES03(wl::tuint8 iVal) 
	{
		std::vector<long> vRps ;
